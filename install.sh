...
# ---
# - minimal setup for vim, zsh, tmux, wezterm, lite i3 WM for arch and
...
main() {
  ...
  git -C "$DOTFILES_DIR" submodule update --init --rebase --recursive &>/dev/null
  git -C "$DOTFILES_DIR" submodule sync --recursive &>/dev/null
